    ...
    <div class="min-h-screen ">
        ...
        <div class="p-4">
            ...
            <div class="mt-12">
                                ...
                                <tbody>
                                            ...
                                            <div class="w-10/12">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-center items-center h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white"
                                                        style="width: {{ round($growth_percentage_habitantes, 2) }}%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <p
                                                class="block antialiased font-sans text-xs font-medium text-blue-gray-600">
                                                {{ substr($proyecciones->extranjeros, 0, 3) }} K</p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <div class="w-10/12">
                                                <p
                                                    class="antialiased font-sans mb-1 block text-xs font-medium text-blue-gray-600">
                                                    {{ round($growth_percentage_extranjeros, 2) }}%</p>
                                                <div
                                                    class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                                                    <div class="flex justify-center items-center h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white"
                                                        style="width: {{ round($growth_percentage_extranjeros, 2) }}%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <div class="flex items-center gap-4">
                                                <p
                                                    class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold">
                                                    Habitantes de Santa Cruz</p>
                                            </div>
                                        </td>
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <p
                                                class="block antialiased font-sans text-xs font-medium text-blue-gray-600">
                                                {{ substr($proyecciones->habitantes_santa_cruz, 0, 4) }} M</p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <div class="w-10/12">
                                                <p
                                                    class="antialiased font-sans mb-1 block text-xs font-medium text-blue-gray-600">
                                                    {{ round($growth_percentage_habitantes_santa_cruz, 2) }}%</p>
                                                <div
                                                    class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                                                    <div class="flex justify-center items-center h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white"
                                                        style="width: {{ round($growth_percentage_habitantes_santa_cruz, 2) }}%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                ...
                <div>
                    <nav class="bg-white border-b fixed z-30 w-full">
                                        ...
                                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                            <div class="flex items-center justify-between mb-4">
                                                <div class="flex-shrink-0">
                                                    <span
                                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{ substr($proyecciones->habitantes, 0, 5) }} M</span>
                                                    <h3 class="text-base font-normal text-gray-500">Habitantes
                                                    </h3>
                                                </div>
                                                <div
                                                    class="flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                                    {{ round($growth_percentage_habitantes, 2) }}%
