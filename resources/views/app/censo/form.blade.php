...
@section('content')
    ...
    <div class="h-screen">
        ...
        <div x-data="app()" x-cloak>
                    ...
                    <div class="border-b-2 py-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div class="flex-1">
                                ...
                                <div x-show="step === 3">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Cuentame sobre tí</div>
                                </div>
                            </div>
                    ...
                    <div class="py-10">
                        <div x-show.transition.in="step === 1">
                            <div class="mb-5 text-center">
                                ...
                                <div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Click para agregar foto de
                                    perfil</div>
                            ...
                            <div class="mb-5">
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nombre Completo</label>
                                <input type="text"
                            ...
                            <div class="mb-5">
                                <label for="email" class="font-bold mb-1 text-gray-700 block">Correo Electrónico</label>
                                <input type="email"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                    placeholder="Ingresa tu correo electrónico...">
                            </div>
                            <div class="mb-5">
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Carnet de
                                    Identidad</label>
                                <input type="text"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                        ...
                        <div x-show.transition.in="step === 2">
                            ...
                            <div class="mb-5">
                                <label for="password" class="font-bold mb-1 text-gray-700 block">Crea una contraseña</label>
                                <div class="text-gray-600 mt-2 mb-4">
                                    Por favor, crea una contraseña segura siguiendo los siguientes criterios:
                                ...
                                <div class="flex items-center mt-4 h-3">
                                    <div class="w-2/3 flex justify-between h-2">
                                        ...
                                        <div :class="{
                                            'bg-orange-400': passwordStrengthText == 'Podría ser más segura' ||
                                                passwordStrengthText == 'Contraseña segura'
                                        }"
                                            class="h-2 rounded-full mr-1 w-1/3 bg-gray-300"></div>
                                        <div :class="{ 'bg-green-400': passwordStrengthText == 'Contraseña segura' }"
                        ...
                        <div x-show.transition.in="step === 3">
                            <div class="mb-5">
                                <label for="email" class="font-bold mb-1 text-gray-700 block">Género</label>
                                ...
                                <div class="flex">
                                    ...
                                    <label
                                        ...
                                        <div class="select-none text-gray-700">Femenino</div>
                                    </label>
                                </div>
                            </div>

                            <div class="mb-5">
                                <label for="profession" class="font-bold mb-1 text-gray-700 block">Profesión</label>
                                <input type="profession"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                    placeholder="ejm.: Ingeniero en Sistemas">
                            </div>
                            <div class="mb-5">
                                <label for="birthdate" class="font-bold mb-1 text-gray-700 block">Fecha de
                                    Nacimiento</label>
                            ...
                            <div class="mb-5">
                                <label for="location" class="font-bold mb-1 text-gray-700 block">Ubicación
                                    Geográfica</label>
                                <div id="map-container">
                                    <iframe id="google-map" width="100%" height="100%" frameborder="0"
                                        style="border:0;"
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3821.7918791795554!2d-63.17055368586038!3d-17.782799787133053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x92ee0171f618bb37%3A0x6b2a6ab90685e0e9!2sSanta%20Cruz%20de%20la%20Sierra%2C%20Bolivia!5e0!3m2!1sen!2sus"
                                        allowfullscreen>
                                    </iframe>
                                    {{-- <button id="current-location-btn" class="text-gray-700 font-bold">Encontrar mi ubicación</button> --}}
                                </div>
            ...
            <!-- Bottom Navigation -->
            <div class=" bottom-0 left-0 right-0 py-5 shadow-md" x-show="step != 'complete'">
                <div class="max-w-3xl mx-auto px-4">
                    <div class="flex justify-between">
                        <div class="w-1/2">
                            <a x-show="step > 1" @click="step--"
                                class="cursor-pointer w-32 focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-gray-600 bg-white hover:bg-gray-100 font-medium border">Anterior</a>
                        </div>
                ...
                return {
                    ...
                    checkPasswordStrength() {
                        ...
                        if (strongRegex.test(value)) {
                            ...
                            this.passwordStrengthText = "Podría ser más segura";
                        } else {
                            this.passwordStrengthText = "Demasiado vulnerable";
                        }
                    }
                }
            }
